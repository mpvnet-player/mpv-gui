...
public partial class MessageBoxEx : Window, INotifyPropertyChanged
{
    ...
    void InitTop(string msg, string title)
    {
        ...
        if (Url != null)
        {
            ...
            tbUrl.ToolTip = new System.Windows.Controls.ToolTip() { Content = Url.ToString() };
        }
    }
    ...
    void TbUrl_MouseLeftButtonUp(object sender, MouseButtonEventArgs e) => mpvgui.ProcessHelp.ShellExecute(Url?.ToString());
