        ...
        public bool UseNewMsgModel {
            get {
                if (!_UseNewMsgModel.HasValue)
                    _UseNewMsgModel = InputConfContent.Contains("script-message-to mpvgui");
                        ...
                        case mpv_event_id.MPV_EVENT_CLIENT_MESSAGE:
                            {
                                ...
                                if (UseNewMsgModel && args[0] != "mpv-gui")
                                    App.RunTask(() => Commands.Execute(args[0], args.Skip(1).ToArray()));
                                else if (args.Length > 1 && args[0] == "mpv-gui")
        ...
        public void ShowLogo()
        {
            ...
            using (Bitmap bmp = new Bitmap(len, len))
            {
                using (Graphics gx = Graphics.FromImage(bmp))
                {
                    ...
                    Bitmap bmp2 = (december && App.ShowSantaLogo) ? Properties.Resources.mpvnet_santa : Properties.Resources.mpvgui;
