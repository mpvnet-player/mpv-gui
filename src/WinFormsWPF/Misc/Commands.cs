    ...
    public class Commands
    {
        ...
        public static void ShowHistory()
        {
            ...
            else
            {
                if (Msg.ShowQuestion("Create a 'history.txt' file in the config folder?" + BR2 +
                    "mpv-gui will write the date, time, play length and path of watched files to it.") == MessageBoxResult.OK)
        ...
        public static void ShowInfo()
        {
            ...
            if (File.Exists(path))
            {
                ...
                {
                    Core.Command("script-message-to mpvgui show-media-info osd");
                    return;
                }
            }
        ...
        public static void ShowMediaInfo(string[] args) => App.InvokeOnMainThread(() =>
        {
            if (args == null || args.Length == 0)
            {
                (string Name, string Value)[] pairs = {
                    ("Show text box",    "script-message-to mpvgui show-media-info default"),
                    ("Show text editor", "script-message-to mpvgui show-media-info editor"),
                    ("Show on screen",   "script-message-to mpvgui show-media-info osd"),
                    ("Show full",        "script-message-to mpvgui show-media-info editor full"),
                    ("Show raw",         "script-message-to mpvgui show-media-info editor full raw") };
        ...
        {
            (string Name, string Value)[] pairs = {
                ("Register video file associations", "script-message-to mpvgui reg-file-assoc video"),
                ("Register audio file associations", "script-message-to mpvgui reg-file-assoc audio"),
                ("Register image file associations", "script-message-to mpvgui reg-file-assoc image"),
                ("Unregister file associations",     "script-message-to mpvgui reg-file-assoc unreg") };
