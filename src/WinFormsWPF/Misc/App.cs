...
namespace mpvgui
{
    public static class App
    {
        ...
        public static string ConfPath { get => Core.ConfigFolder + "mpvgui.conf"; }
        ...
        public static void Init()
        {
            ...
            if (DebugMode)
            {
                try
                {
                    string filePath = Core.ConfigFolder + "mpvgui-debug.log";
        ...
        public static string Version => "Copyright (C) 2000-2022 mpv-gui/mpv/mplayer\n" +
            $"mpv-gui {Application.ProductVersion}" + GetLastWriteTime(Application.ExecutablePath) + "\n" +
        ...
        static bool IsStoreVrsion => Application.StartupPath.Contains("FrankSkare.mpv-gui");
